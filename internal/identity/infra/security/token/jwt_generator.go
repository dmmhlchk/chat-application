...
func (g *JWTGenerator) Generate(userID string, sessionID string, ttl time.Duration) (string, error) {
	now := time.Now()
...
func (g *JWTGenerator) Validate(tokenString string) (string, string, error) {
